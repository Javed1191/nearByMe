...
public class ColorTemplate {
    ...
    public static final int[] PASTEL_COLORS = {
           /* Color.rgb(64, 89, 128), Color.rgb(149, 165, 124), Color.rgb(217, 184, 162),
            ...
            /*Color.rgb(50, 98, 146), Color.rgb(0, 27, 74),Color.rgb(14, 62, 110),
            Color.rgb(86, 134, 182),Color.rgb(50, 98, 146),Color.rgb(0, 0, 0), Color.rgb(0, 0, 38)*/

            rgb("#5686B6"), rgb("#000000"), rgb("#001B4A"), rgb("#0E3E6E"), rgb("#326292")
